                ...
                <div class="row justify-content-center form-bg-image">
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="signin-inner my-3 my-lg-0 bg-white shadow border-0 rounded p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form action="{{route('users.check-email')}}" method="post">
                                @csrf
                                <div class="mb-4">
                                    <label for="email">Your Email</label>
                                    <div class="input-group">
                                        <input type="email" name="email" value="{{ old('email')}}" class="form-control @error ('email') is-invalid @enderror" id="email" placeholder="example@something.com" required>
                                        @error('email')
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-gray-800">Send Code</button>
                                </div>
                            </form>
                        </div>
                    </div>
